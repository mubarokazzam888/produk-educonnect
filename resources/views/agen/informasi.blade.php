  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Agen {{Auth::user()->name}}, ini halaman informasi</h1> <!-- nama 1 -->
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card" style="background-color: #ffffff">
        <div class="card-header" style="background-color: #bbbbbb">
          <h3 class="card-title">Data mahasiswa yang sudah daftar ulang menggunakan kode</h3> <!-- nama 2 -->
        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                @forelse ($info__agen as $key=>$item)
                  <tr>
                    <td>{{$key + 1}}</td>
                    <td>{{$item->name}}</td>
